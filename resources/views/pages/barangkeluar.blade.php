  ...
  <script>
    ...
    $('.editBarang').on('click', function () {
      ...
      $.ajax({
        ...
        error: function () {
          var errorMessage = xhr.responseJSON.error || "Gagal update barang!";
    ...
    $('.deleteBarangMasuk').on('click', function() {
      let id = $(this).data('id');
      console.log(`/barang-keluar/delete/${id}`)
      if (confirm("Apakah kamu yakin ingin menghapus data ini?")) {
        $.ajax({
          url: `/barang-keluar/delete/${id}`,
          type: "DELETE",
          ...
          error: function() {
            var errorMessage = xhr.responseJSON.error || "Gagal menghapus barang!";
            toastr.error(errorMessage);  
          }
        });
      }
